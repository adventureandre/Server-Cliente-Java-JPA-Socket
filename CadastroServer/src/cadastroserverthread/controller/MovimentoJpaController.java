 ...
 */
package cadastroserverthread.controller;

import cadastroserverthread.controller.exceptions.NonexistentEntityException;
import cadastroserverthread.model.Movimento;
import java.io.Serializable;
import javax.persistence.Query;
import javax.persistence.EntityNotFoundException;
import javax.persistence.criteria.CriteriaQuery;
import javax.persistence.criteria.Root;
import cadastroserverthread.model.Pessoas;
import cadastroserverthread.model.Produto;
...
public class MovimentoJpaController implements Serializable {
    ...
    public void create(Movimento movimento) {
        ...
        try {
            ...
            Pessoas idPessoa = movimento.getIdPessoa();
            if (idPessoa != null) {
    ...
    public void edit(Movimento movimento) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            Pessoas idPessoaOld = persistentMovimento.getIdPessoa();
            Pessoas idPessoaNew = movimento.getIdPessoa();
